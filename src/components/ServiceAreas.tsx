  ...
  return (
    <section className="py-20 bg-[#f8fafc] text-slate-900 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <MapPin
                    className={`w-4 h-4 ${
                      area.isPrimaryOffice ? 'text-[#d4af37]' : 'text-slate-400'
                    }`}
                  />
                </div>
                ...
                <h3
                  className={`font-serif text-2xl font-bold mb-2 ${
                    area.isPrimaryOffice ? 'text-white' : 'text-[#0b132b]'
                  }`}
                >
                  {area.city}
                </h3>
                ...
                <p
                  className={`text-xs leading-relaxed font-sans ${
                    area.isPrimaryOffice ? 'text-slate-300' : 'text-slate-600'
                  }`}
                >
                  {area.description}
                </p>
        ...
        <div className="mt-10 p-4 rounded-xl bg-slate-100 border border-slate-200 text-center max-w-2xl mx-auto">
          <p className="text-xs text-slate-700 font-sans">
            <strong className="text-[#0b132b]">Note on Chamber Consultations:</strong> All in-person client conferences and brief discussions are conducted at our primary office in <strong>Sector 43-B, Chandigarh</strong>, or scheduled near court complexes.
          </p>
        </div>
